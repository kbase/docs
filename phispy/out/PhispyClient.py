...
class Phispy:
    ...
    def get_all_training_sets(self, ):
        ...
        arg_hash = { 'method': 'Phispy.get_all_training_sets',
                     'params': [],
                     'version': '1.1'
                     }
    ...
    def find_prophages(self, training_set_id, genomeTO):

        arg_hash = { 'method': 'Phispy.find_prophages',
                     'params': [training_set_id, genomeTO],
                     'version': '1.1'
                     }
