package Bio::KBase::PlantExpressionService::Service;
...
our %return_counts = (
        'get_repid_by_sampleid' => 1,
        'get_experiments_by_seriesid' => 1,
        'get_experiments_by_sampleid' => 1,
        'get_experiments_by_sampleid_geneid' => 1,
        'get_eo_sampleidlist' => 1,
        'get_po_sampleidlist' => 1,
        'get_all_po' => 1,
        'get_all_eo' => 1,
        'get_po_descriptions' => 1,
        'get_eo_descriptions' => 1,
        'version' => 1,
);
...
sub call_method {
    ...
    my $ctx = Bio::KBase::PlantExpressionService::ServiceContext->new(client_ip => $self->_plack_req->address);
    
    my $args = $data->{arguments};

    # Service PlantExpression does not require authentication.
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service PlantExpression.");
    }
...
package Bio::KBase::PlantExpressionService::ServiceContext;

use strict;

=head1 NAME

Bio::KBase::PlantExpressionService::ServiceContext
