...
option_list=list( 
  ...
  make_option(c("-n", "--net_method"),type="character",default='simple', 
              help="Method to construct gene co-expression network. When net_method = ‘simple’ or ‘s’, the function constructs gene co-expression network using Pearson correlation matrix. When net_method = “WGCNA” or ‘w’, the function constructs gene co-expression network using Pearson correlations between genes, and “signed” network by WGCNA. [default \"%default\"]"), 
