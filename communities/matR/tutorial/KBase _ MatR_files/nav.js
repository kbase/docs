...
function hide() {
    ...
    var mainNav = $('.top-nav > #MenuBar1').children('li');
...
$(document).ready(function() { 
    $('.top-nav > #MenuBar1').children('li').hover(showSubmenu, timer)
    $('.top-nav > #MenuBar1').children('li').find('a').hover(linkEnter, linkOut);
});
